...
(cl:defmethod cl:initialize-instance :after ((m <JointTorqueComparison>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTorqueComparison)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name panda_mpc-msg:<JointTorqueComparison> is deprecated: use panda_mpc-msg:JointTorqueComparison instead.")))

(cl:ensure-generic-function 'tau_error-val :lambda-list '(m))
(cl:defmethod tau_error-val ((m <JointTorqueComparison>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mpc-msg:tau_error-val is deprecated.  Use panda_mpc-msg:tau_error instead.")
  (tau_error m))

(cl:ensure-generic-function 'tau_commanded-val :lambda-list '(m))
(cl:defmethod tau_commanded-val ((m <JointTorqueComparison>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mpc-msg:tau_commanded-val is deprecated.  Use panda_mpc-msg:tau_commanded instead.")
  (tau_commanded m))

(cl:ensure-generic-function 'tau_measured-val :lambda-list '(m))
(cl:defmethod tau_measured-val ((m <JointTorqueComparison>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mpc-msg:tau_measured-val is deprecated.  Use panda_mpc-msg:tau_measured instead.")
  (tau_measured m))
...
(cl:defmethod root_mean_square_error-val ((m <JointTorqueComparison>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader panda_mpc-msg:root_mean_square_error-val is deprecated.  Use panda_mpc-msg:root_mean_square_error instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTorqueComparison>)))
  ...
  "panda_mpc/JointTorqueComparison")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTorqueComparison)))
  "Returns string type for a message object of type 'JointTorqueComparison"
  "panda_mpc/JointTorqueComparison")
